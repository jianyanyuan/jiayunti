 ...
 * @LastEditors: 张飞达
 * @LastEditTime: 2020-10-12 13:57:34
 * @Description:申请列表
-->
      ...
      <el-table-column align="center" label="操作" min-width="140">
        <template slot-scope="scope">
          <el-row type="flex" justify="space-around">
            <el-button v-if="scope.row.status === 1 && scope.row.dissent" size="mini" type="info" @click="dissentResult(scope.row)">
              <router-link :to="{path:'/community/collapse',query:{applyId:scope.row.Id}}">异议反馈</router-link>
            </el-button>
