...
<template>
  <div class="app-container chart-container">
    <el-row :gutter="10" class="container-top">
      <el-col :xs="24" :sm="8">
        <el-card class="container-aside" header="正在申请中" @click.native="projectClick('applying')">
      ...
      <el-col :xs="24" :sm="8">
        <el-card class="container-aside" header="正在施工中" @click.native="projectClick('constructioning')">
          <svg-icon icon-class="applyIcon" class="aside-icon" />
          <div class="card-message">
            <div class="card-num">10,000</div>
          </div>
      ...
      <el-col :xs="24" :sm="8">
        <el-card class="container-aside" header="已安装" @click.native="projectClick('finished')">
    ...
    <el-row :gutter="10" class="container-top">
      <el-col :xs="24" :sm="24" :md="24" :lg="18" :xl="16">
        <el-card header="已发放补贴" style="margin-bottom: 20px;">
          <el-table :data="tableData" border style="width: 100%" height="320">
            <el-table-column prop="street" label="街道" width="180" />
            <el-table-column prop="project" label="补贴项目" width="180" />
            <el-table-column prop="amount" label="补贴金额" />
            <el-table-column label="操作">
              <el-button type="text" size="medium" @click.native="bonusClick('streetId')">详情</el-button>
            </el-table-column>
          </el-table>
        </el-card>
      </el-col>
      <el-col :xs="24" :sm="24" :md="24" :lg="6" :xl="8">
        <el-card class="container-aside" style="margin-bottom:17px" header="补贴金额" @click.native="bonusClick">
          <svg-icon icon-class="applyIcon" class="aside-icon" />
          <div class="card-message">
            <div class="card-num">10,000</div>
          </div>
        </el-card>
        <el-card class="container-aside" header="补贴项目" style="margin-bottom: 20px;" @click.native="bonusClick">
          <svg-icon icon-class="completed" class="aside-icon" />
          <div class="card-message">
            <div class="card-num">10,000</div>
          </div>
    ...
    <el-card style="width:100%">
      <el-row slot="header" type="flex" justify="space-between" align="middle">
        <div class="tabs-nav-list">
          ...
          <div :class="['tabs-tab',{'tabs-tab-active':btnFocusId === 2}]" @click="btnFocusId = 2">
            已安装
          </div>
        </div>
        <span>
...
export default {
  ...
  data() {
    return {
      ...
      btnFocusId: 0,
      tableData: [{ street: '横塘街道', project: 1000, amount: 100000 }]
    }
  },
  created() {
  ...
  methods: {
    bonusClick() {
      this.$router.push('/admin/bonus-detail')
    },
    projectClick() {
      this.$router.push('/admin/project-detail')
    },
    initChart() {
