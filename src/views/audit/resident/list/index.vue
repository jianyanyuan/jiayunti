 ...
 * @LastEditors: zfd
 * @LastEditTime: 2020-10-23 08:57:31
 * @Description:申请列表
-->
...
<template>
  <div class="app-container">
    ...
    <!-- 新增申请 -->
    <el-dialog v-el-drag-dialog title="新增申请" center :visible.sync="model.visible" :close-on-click-modal="false" width="600px" @closed="resetForm">
